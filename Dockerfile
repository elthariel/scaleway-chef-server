...
RUN apt-get -q update && \
    ...
    wget -q0 'https://github.com/elthariel/chef-server/releases/download/v12.5.0-arm-alpha/chef-server-core_12.9.1.20161020161349-1_armhf.deb' -o /tmp/chef-server-core_12.9.1.deb && \
